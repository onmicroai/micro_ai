...
class RunPostSerializer(serializers.ModelSerializer):
    class Meta:
        model = Run
        fields = ['ma_id', 'user_id', 'session_id', 'ai_model', 'no_submission', 'request_skip', 'scored_run', 'minimum_score', 'rubric', 'top_p', 'temperature', 'max_tokens', 'satisfaction', 'response', 'run_uuid', 'litellm_response_id']
